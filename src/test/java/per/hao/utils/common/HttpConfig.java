...
//	private Map<String, Object> getParams;
     ...
     * 解决多线程处理时，url被覆盖问题
     */
    private ThreadLocal<Map<String, Object>> maps = new ThreadLocal<>();

    /**
     * @param client HttpClient对象
     * @return 返回当前对象
     */
    public HttpConfig getClient(HttpClient client) {
        this.client = client;
        return this;
    }
    ...
    /**
     * @param header HttpHeader头信息
     * @return 返回当前对象
     */
    public HttpConfig setHttpHeader(HttpHeader header) {
        this.headers = header.build();
        return this;
    }
     ...
     * @return 返回当前对象
     */
    public HttpConfig setHttpHeader(Header[] headers) {
     ...
     * @return 返回当前对象
     */
    public HttpConfig setHttpHeader(Header[] headers, boolean isReturnRespHeaders) {
        this.headers = headers;
     ...
     * @return 返回当前对象
     */
    public HttpConfig getParams(Map<String, Object> params) {
//		synchronized (getClass()) {
//			if(this.getParams==null || getParams==null){
//				this.getParams = getParams;
//			}else {
//				this.getParams.putAll(getParams);;
//			}
//		}
        Map<String, Object> m = maps.get();
        if (m == null || m == null || params == null) {
            m = params;
        } else {
            m.putAll(params);
        }
    ...
    /**
     * @param body 以json格式字符串作为参数
     * @return 返回当前对象
     */
    public HttpConfig setBody(String body) {
        this.json = body;
        Map<String, Object> map = new HashMap<>();
        map.put(Utils.ENTITY_JSON, body);
        maps.set(map);
        return this;
    }
...
//				this.getParams= new HashMap<String, Object>();
//			}
//		}
//		getParams.put(Utils.ENTITY_MULTIPART, filePaths);
//		getParams.put(Utils.ENTITY_MULTIPART+".name", inputName);
//		getParams.put(Utils.ENTITY_MULTIPART+".rmCharset", forceRemoveContentTypeChraset);
    ...
    public HttpConfig isRedirect(boolean redirectEnable) {
        RequestConfig config = RequestConfig.custom()
